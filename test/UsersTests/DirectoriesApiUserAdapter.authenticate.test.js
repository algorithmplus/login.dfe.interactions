...
describe('When authenticating a user with the api', function () {
  ...
  it('it should post to the clients directory', async function () {
  ...
  it('it should send entered username and password', async function () {
    await adapter.authenticate(username, password, client);
  ...
  it('it should user the jwt token for authorization', async function () {
    await adapter.authenticate(username, password, client);

    expect(rpOpts.headers.authorization).to.equal(`bearer ${bearerToken}`);
  });

  it('then it should throw an error if the api call failed', async function() {
    rpAction = () => {
  ...
  describe('with valid credentials', function () {
    ...
    it('then it should return the user id', async function () {
  ...
  describe('with invalid credentials', function () {
    ...
    it('then it should return null', async function () {
      const userId = await adapter.authenticate(username, password, client);
